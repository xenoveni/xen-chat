...
XenChatContainer::load('rendering/filters/pre/XenChatLinksPreFilter');
XenChatContainer::load('rendering/filters/XenChatShortcodeConstructor');
XenChatContainer::load('services/XenChatImagesService');
XenChatContainer::load('services/user/XenChatActions');
XenChatContainer::load('services/user/XenChatAuthentication');

class XenChatLinksPreFilterTest extends PHPUnit_Framework_TestCase {
	
	/**
	 * @dataProvider dataNoImages
	 */
    public function testPositiveNoImages($input, $output) {
        XenChatContainer::replace('services/user/XenChatActions', new XenChatActionsStub());
        XenChatContainer::replace('services/XenChatImagesService', new XenChatImagesServiceStub());
        XenChatContainer::replace('services/user/XenChatAuthentication', new XenChatAuthenticationStub());
		$linksPreFilter = new XenChatLinksPreFilter();
...
class XenChatImagesServiceStub extends XenChatImagesService {
...
class XenChatActionsStub extends XenChatActions {
	public function __construct() { }
}

class XenChatAuthenticationStub extends XenChatAuthentication {
	public function __construct() { }
}