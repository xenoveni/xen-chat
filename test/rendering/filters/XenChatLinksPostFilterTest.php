...
XenChatContainer::load('rendering/filters/post/XenChatLinksPostFilter');

class XenChatLinksPostFilterTest extends PHPUnit_Framework_TestCase {
    ...
    public function testPositiveNoLinks($input, $output) {
        ...
        $filter = new XenChatLinksPostFilter();
