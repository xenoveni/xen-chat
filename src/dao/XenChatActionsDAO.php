...
/**
 * Xen Chat actions DAO. Actions are commands sent from the chat server to each client.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatActionsDAO {
	...
	*/
	...
	public function __construct() {
		XenChatContainer::load('model/XenChatAction');
		$this->options = XenChatOptions::getInstance();
		$this->table = XenChatInstaller::getActionsTable();
	}

	/**
	 * Creates or updates the action and returns it.
	 *
	 * @param XenChatAction $action
	 *
	 * @return XenChatAction
	...
	/**
	 * Converts raw object into XenChatAction object.
	 *
