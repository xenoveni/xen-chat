...
class XenChatKicksDAO {
	...
	public function __construct() {
		...
		$this->table = XenChatInstaller::getKicksTable();
	}
	/**
	 * Creates or updates the kick and returns it.
	 *
	 * @param XenChatKick $kick
	 *
	 * @return XenChatKick
	...
	/**
	 * Converts raw object into XenChatKick object.
	 *
