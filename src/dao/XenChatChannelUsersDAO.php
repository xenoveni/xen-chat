...
class XenChatChannelUsersDAO {
	...
	*/
	...
	public function __construct() {
		XenChatContainer::load('model/XenChatChannelUser');
	 ...
	 *
	 * @param XenChatChannelUser $channelUser
	 *
	...
	public function save($channelUser) {
		...
		$table = XenChatInstaller::getChannelUsersTable();
		$columns = array(
	 ...
	 *
	 * @return XenChatChannelUser|null
	 */
	...
	public function getAllActive($limitToWordPressUsersIds = array()) {
		...
		$table = XenChatInstaller::getChannelUsersTable();
		$usersTable = XenChatInstaller::getUsersTable();
		$sql = sprintf(
		...
		/** @var XenChatChannelUser[] $channelUsers */
		$channelUsers = array();
	...
	/**
	 * Converts stdClass object into XenChatChannelUser object.
	 *
