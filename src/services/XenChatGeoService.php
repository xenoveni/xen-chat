...
/**
 * Xen Chat geo-targeting service class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatGeoService {
     ...
     *
	 * @return XenChatGeoDetails
	 */
	public function getGeoDetails($ipAddress) {
        XenChatContainer::load('model/XenChatGeoDetails');
