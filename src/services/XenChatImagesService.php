...
/**
 * Xen Chat image services class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatImagesService {
	const UPLOAD_FILE_NAME = '_xen_chat_upload';
	...
	*/
	public function getPreparedImage($binaryImageData) {
		...
		try {
			...
			/** @var XenChatImageEditor $imageEditor */
			$imageEditor = XenChatContainer::get('services/XenChatImageEditor');
	...
	private function getTempFileImageInfo($safeResize) {
		...
		if (is_array($fileInfo)) {
			...
			if (!array_key_exists($mimeType, $this->supportedExtensions)) {
				...
				throw new Exception($this->options->getEncodedOption('message_error_7', __('Unsupported type of file', 'xen-chat')));
			}
	...
	*/
	private function logError($message) {
		@trigger_error('WordPress Xen Chat plugin error (ImagesService): '.$message, E_USER_NOTICE);
	}
