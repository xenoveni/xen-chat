...
/**
 * XenChat message text processing utility.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatTextProcessing {
	...
	public static function cutMessageText($text, $messageMaxLength) {
		...
		$matches = array();
		$shortcodes = array_map(function($shortcode) { return '('.$shortcode.')'; }, XenChatShortcodeConstructor::SHORTCODES);
