 ...
 */
class XenChatInstaller {

	public static function getUsersTable() {
		global $wpdb;

		return $wpdb->prefix.'xen_chat_users';
	}

	public static function getMessagesTable() {
		global $wpdb;
		
		return $wpdb->prefix.'xen_chat_messages';
	}
	
	public static function getBansTable() {
		global $wpdb;

		return $wpdb->prefix.'xen_chat_bans';
	}

	public static function getKicksTable() {
		global $wpdb;

		return $wpdb->prefix.'xen_chat_kicks';
	}
	
	public static function getActionsTable() {
		global $wpdb;
		
		return $wpdb->prefix.'xen_chat_actions';
	}
	
	public static function getChannelUsersTable() {
		global $wpdb;
		
		return $wpdb->prefix.'xen_chat_channel_users';
	}
	
	public static function getChannelsTable() {
		global $wpdb;
		
		return $wpdb->prefix.'xen_chat_channels';
	}
	...
	public static function uninstall() {
        ...
        /** @var XenChatMessagesService $messagesService */
		$messagesService = XenChatContainer::get('services/XenChatMessagesService');
		...
		XenChatOptions::getInstance()->dropAllOptions();
	}
}