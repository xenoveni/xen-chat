 ...
 */
class XenChatWidget extends WP_Widget {
	
	public function __construct() {
		$widgetOps = array('classname' => 'XenChatWidget', 'description' => 'Displays Xen Chat' );
		parent::__construct('XenChatWidget', 'Xen Chat Window', $widgetOps);
	}
	...
	public function widget($args, $instance) {
		...
		echo $xenChat->getRenderedShortcode($parsedOptions);
