...
/**
 * Xen Chat admin modes settings..
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatModesTab extends XenChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array('classic_disable_channel', 'Disable Public Channels', 'booleanFieldCallback', 'boolean',
				...
				<strong>Notice:</strong> This option will take effect only if <a href="https://kainex.pl/projects/wp-plugins/xen-chat-pro/documentation/features/private-messages/">private messages</a> are enabled.'
			),
			...
			array('browser_location', 'Browser Location', 'selectCallback', 'string', 'The location of <a href="https://kainex.pl/projects/wp-plugins/xen-chat-pro/faq/what-exactly-is-a-browser-i-found-this-in-the-chats-configuration/" target="_blank">the browser</a>.', self::getUsersListLocation()),
			array('users_list_width', 'Browser Width', 'stringFieldCallback', 'integer',
				'Percentage width of <a href="https://kainex.pl/projects/wp-plugins/xen-chat-pro/faq/what-exactly-is-a-browser-i-found-this-in-the-chats-configuration/" target="_blank">the browser</a> area (a column containing the users list). Empty field sets default value of 30%.'
			),
