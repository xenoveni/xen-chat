...
/**
 * Xen Chat admin muting settings tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatBansTab extends XenChatAbstractTab {
	...
	public function banAddCallback() {
		$url = admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=addBan");
