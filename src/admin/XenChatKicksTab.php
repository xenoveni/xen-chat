<?php
/**
 * Xen Chat admin kicks settings tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatKicksTab extends XenChatAbstractTab {
	...
	public function kickAddCallback() {
		$url = admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=addKick&tab=kicks");
		printf(
