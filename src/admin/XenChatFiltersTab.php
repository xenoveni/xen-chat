...
/**
 * Xen Chat admin messages filters tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatFiltersTab extends XenChatAbstractTab {
	...
	public function filterAddCallback() {
		$url = admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=addFilter");
