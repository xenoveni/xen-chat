...
/**
 * Xen Chat admin moderation settings tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatModerationTab extends XenChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array(
				...
				'User roles allowed to approve pending messages when Pending Messages feature is on (see below).<br />Alternatively, assign "xen_chat_approve_message" capability to any custom role.<br />',
				self::getRoles()
			),
			...
			array(
				...
				'User roles allowed to edit messages.<br /> Alternatively, assign "xen_chat_edit_message" capability to any custom role.', self::getRoles()
			),
			...
			array(
				...
				'User roles allowed to delete messages.<br /> Alternatively, assign "xen_chat_delete_message" capability to any custom role.', self::getRoles()
			),

			array(
				'permission_ban_user_role', 'Mute Action', 'checkboxesCallback', 'multivalues',
				'User roles allowed to mute users.<br /> Alternatively, assign "xen_chat_mute_user" capability to any custom role.', self::getRoles()
			),
			...
			array(
				...
				'User roles allowed to ban users.<br /> Alternatively, assign "xen_chat_ban_user" capability to any custom role.', self::getRoles()
			),

			array(
				'permission_spam_report_role', 'Spam Report Action', 'checkboxesCallback', 'multivalues',
				'User roles allowed to report spam messages.<br /> Alternatively, assign "xen_chat_spam_report" capability to any custom role.', self::getRoles()
			),
			array(
	...
	public function getDefaultValues() {
		return array(
			...
			'spam_report_subject' => '[Xen Chat] Spam Report',
			'spam_report_content' => "Xen Chat Spam Report\n\n".
				'Channel: {channel}'."\n".
				'Message: {message}'."\n".
	...
	public function moderatorAddCallback() {
		$url = admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=addModerator");
