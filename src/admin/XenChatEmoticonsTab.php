...
/**
 * Xen Chat admin emoticons settings tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatEmoticonsTab extends XenChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array('custom_emoticons_emoticon_width', 'Emoticon Width In Chat', 'selectCallback', 'string', 'Width of a single emoticon in the chat window.', XenChatEmoticonsTab::getImageSizes()),
	...
	public static function getEmoticonSets() {
		return array(
			0 => '-- No emoticons --',
			1 => 'Set 1',
			'_DISABLED_pro_2' => 'Set 2 (available in Xen Chat Pro)',
			'_DISABLED_pro_3' => 'Set 3 (available in Xen Chat Pro)',
			'_DISABLED_pro_4' => 'Set 4 (available in Xen Chat Pro)',
		);
	}
	...
	public function emoticonAddCallback() {
		$url = admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=addEmoticon");
