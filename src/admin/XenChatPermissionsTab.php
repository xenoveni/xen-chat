...
/**
 * Xen Chat admin permissions settings tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatPermissionsTab extends XenChatAbstractTab {
	...
	public function ruleAddCallback() {
		$url = admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=addPMRule");
