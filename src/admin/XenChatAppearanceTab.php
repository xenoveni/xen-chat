...
/**
 * Xen Chat admin appearance settings tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatAppearanceTab extends XenChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array('text_size_chat', 'Font Size', 'selectCallback', 'string', '', XenChatAppearanceTab::getFontSizes()),
			...
			array('messages_order', 'Messages Order', 'selectCallback', 'string', 'Sorting order of the messages', XenChatAppearanceTab::getSortingOrder()),
			...
			array('text_size', 'Font Size', 'selectCallback', 'string', '', XenChatAppearanceTab::getFontSizes()),
			
			array('messages_time_mode', 'Message Time Mode', 'selectCallback', 'string', 'Format of the date and time displayed next to each message', XenChatAppearanceTab::getTimeModes()),
			array(
			...
			array('link_wp_user_name', 'Username Display Mode', 'selectCallback', 'string', '
			    ...
			    ', XenChatAppearanceTab::getUserNameLinkModes()),
			...
			array('input_controls_location', 'Input Controls Location', 'selectCallback', 'string', 'Location of the input field, submit button and customizations panel section.', XenChatAppearanceTab::getInputFieldLocation()),
			...
			array('text_size_users_list', 'Font Size', 'selectCallback', 'string', 'Font size', XenChatAppearanceTab::getFontSizes()),
			...
			array(
				...
				'<a href="https://kainex.pl/projects/wp-plugins/xen-chat-pro/documentation/features/private-chat-button/">Read more</a>'
			),
	...
	public static function getAllThemes() {
		return array(
			...
			'colddark' => 'Cold Dark',
			'airflow' => 'Air Flow',
			'_DISABLED_pro_crystal' => 'Crystal (available in Xen Chat Pro)',
			'_DISABLED_pro_clear' => 'Clear (available in Xen Chat Pro)',
			'_DISABLED_pro_balloon' => 'Balloon (available in Xen Chat Pro)'
		);
	}
	...
	public function textColorUserRolesCallback() {
		...
		foreach ($roles as $roleSlug => $roleName) {
			...
			printf(
				'<tr>'.
				'<td>%s:&nbsp;</td><td><input type="text" id="text_color_user_roles_%s" name="'.XenChatOptions::OPTIONS_NAME.'[text_color_user_roles][%s]" value="%s" class="wc-color-picker" /> </td>'.
				'</tr>',
