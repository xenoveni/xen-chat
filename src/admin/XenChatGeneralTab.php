...
/**
 * Xen Chat admin general settings tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatGeneralTab extends XenChatAbstractTab {
	...
	public function getFields() {
		...
		return array(
			...
			array(
				...
				'<strong>Notice:</strong> Please remember to enable User Groups support in BuddyPress settings otherxen the integration will not work.'
			),
			array(
	...
	public function openingHoursCallback($args) {
		...
		$openingModesSelect = sprintf(
			...
			XenChatOptions::OPTIONS_NAME, $id,
	...
	public static function getAllModes() {
		return array(
			'' => 'Classic chat',
			'_DISABLED_pro_fb' => 'Facebook-like chat (available in Xen Chat Pro)',
		);
	}
