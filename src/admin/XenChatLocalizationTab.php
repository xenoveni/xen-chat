...
/**
 * Xen Chat admin localization settings tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatLocalizationTab extends XenChatAbstractTab {

	public function getFields() {
		return array(
			array('_section', 'Localization Settings'),
			array('custom_i18n', 'Enable Custom Localization', 'booleanFieldCallback', 'boolean', 'Enable the option to use the translations defined below. By default Xen Chat plugin uses WordPress translations.'),
	...
	public function getDefaultValues() {
		return array(
			...
			'message_bp_manage_notice_text' => 'These permissions will work only with enabled admin actions in Xen Chat Pro settings',
			'message_bp_manage_shortcode' => 'Xen Chat Pro detailed parameters (shortcode syntax required)',
