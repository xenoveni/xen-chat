...
/**
 * Xen Chat admin messages notifications tab class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatNotificationsTab extends XenChatAbstractTab {
	...
	private function getNotificationForm($notification) {
		...
		$url = $notification !== null
				? admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=editNotification&notificationId=".$notification->getId())
				: admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=addNotification");
	...
	private function getUserNotificationForm($notification) {
		$details = $notification !== null ? $notification->getDetails() : array();
		$url = $notification !== null
			? admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=editUserNotification&notificationId=".$notification->getId())
			: admin_url("options-general.php?page=".XenChatSettings::MENU_SLUG."&wc_action=addUserNotification");
