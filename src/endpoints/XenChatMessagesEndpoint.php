...
/**
 * Xen Chat messages endpoint class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatMessagesEndpoint extends XenChatEndpoint {
	...
	public function messagesEndpoint() {
		...
		try {
			...
			$lastId = intval(XenChatCrypt::decryptFromString($encryptedLastId));
			...
			foreach ($channels as $channel) {
				$channelEncryptedIds[$channel->getName()] = XenChatCrypt::encryptToString('c|'.$channel->getId());
			}
