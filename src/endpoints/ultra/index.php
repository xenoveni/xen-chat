...
// make sure it is used only for "xen_chat_messages_endpoint" action:
if (!isset($_REQUEST['action']) || $_REQUEST['action'] !== 'xen_chat_messages_endpoint') {
    header('HTTP/1.0 404 Not Found');
    die('');
}
...
// get a message:
$channelsTable = $variables['table_prefix'].'xen_chat_channels';
$messagesTable = $variables['table_prefix'].'xen_chat_messages';
