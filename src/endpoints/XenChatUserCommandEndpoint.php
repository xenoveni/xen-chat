...
/**
 * Xen Chat user commands endpoint class.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatUserCommandEndpoint extends XenChatEndpoint {
	...
	public function prepareImageEndpoint() {
		...
		try {
			...
			/** @var XenChatImagesService $imagesService */
			$imagesService = XenChatContainer::get('services/XenChatImagesService');
