...
/**
 * XenChat DI container.
 *
 * @author Kainex <contact@kainex.pl>
 */
class XenChatContainer {
	/**
	...
	*/
	...
	public static function getLazy($classPathAndName) {
		...
		self::$proxies[$classPathAndName] = new XenChatContainerProxyClass($classPathAndName);
...
/**
 * Xen Chat DI proxy class.
 */
class XenChatContainerProxyClass {
	/**
	 * @var string
	 */
	...
	/**
	 * XenChatContainerProxyClass constructor.
	 *
	 * @param string $classPathAndName
	 */
	...
	public function __call($name, $arguments) {
		if ($this->targetClassObject === null) {
			$this->targetClassObject = XenChatContainer::get($this->targetClassPathAndName);
		}
