...
export default class AjaxEngine extends Engine {
	...
	constructor(configuration) {
		...
		this.messagesEndpoint = configuration.engines.ajax.apiMessagesEndpointBase + '?action=xen_chat_messages_endpoint';
		this.pastMessagesEndpoint = configuration.engines.ajax.apiWPEndpointBase + '?action=xen_chat_past_messages_endpoint';
		this.userCommandEndpoint = configuration.engines.ajax.apiWPEndpointBase + '?action=xen_chat_user_command_endpoint';
		this.authEndpoint = configuration.engines.ajax.apiWPEndpointBase + '?action=xen_chat_auth_endpoint';
		this.idsCache = {};
		this.lastId = 0;
