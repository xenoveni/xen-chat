...
export default class AjaxEngineSender  {
	...
	constructor(configuration) {
		...
		this.messageEndpoint = configuration.engines.ajax.apiWPEndpointBase + '?action=xen_chat_message_endpoint';
		this.prepareImageEndpoint = configuration.engines.ajax.apiEndpointBase + '?action=xen_chat_prepare_image_endpoint';
	}
