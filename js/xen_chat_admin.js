/**
 * Xen Chat admin support JS
 *
 * @author Kainex <contact@kaine.pl>
 * @link https://kaine.pl/projects/wp-plugins/xen-chat-pro
 */
jQuery(document).ready(function($){
	...
	addCheckboxesBind(
		'#access_mode', "input[name='xen_chat_options_name[access_roles][]'", "input[name='xen_chat_options_name[access_roles][]'"
	);
